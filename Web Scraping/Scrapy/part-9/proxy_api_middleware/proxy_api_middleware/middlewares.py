...
class ProxyApiMiddlewareSpiderMiddleware:
...
class ProxyApiMiddlewareDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
class ScrapeOpsFakeBrowserHeaderAgentMiddleware:
    ...
    def __init__(self, settings):
        ...
        self.scrapeops_fake_browser_headers_active = os.getenv('SCRAPEOPS_FAKE_BROWSER_HEADER_ENABLED')
        self.scrapeops_num_results = os.getenv('SCRAPEOPS_NUM_RESULTS')
        self.headers_list = []
