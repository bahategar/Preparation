...
class Phase5MiddlewareSpiderMiddleware:
...
class Phase5MiddlewareDownloaderMiddleware:
    # Not all methods need to be defined. If a method is not defined,
...
# Access data user agents from setting
# class FakeUserAgentMiddleware:
#     @classmethod
#     def from_crawler(cls, crawler):
#         # NOTE:
...
#         # - cls Parameter: Refers to the class FakeUserAgentMiddleware itself, not an instance of it.
...
#         self.user_agents = settings.get("USER_AGENTS_SETTINGS")
...
# Modify user-agent and headers (all of them) using APIs ScrapeOps
from urllib.parse import urlencode
